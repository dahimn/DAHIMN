...
parser.add_argument('-hop','--hop', help='Hop Number', required=False)
parser.add_argument('-l','--n_layer', help='Layer Number', required=False)
...
if args["dataset"] == 'kvr':
	...
	print('[ERROR] dataset should be set')
	exit()
